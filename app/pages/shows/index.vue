...
<template>
  <div class="container">
    <nav class="nav-buttons">
      <nuxt-link to="/" class="btn-primary">Accueil</nuxt-link>
      <nuxt-link to="/movies" class="btn-primary">Films</nuxt-link>
      <button
      ...
      <button v-else @click="logout" class="btn-primary btn-logout">
        Déconnexion
      </button>
    </nav>
